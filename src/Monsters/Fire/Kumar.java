...
public class Kumar extends Monster
{
    ...
    private void setAbilities()
    {
        ...
        abilities.add(new Heal_Ability("Meditate (2)", 0.3, 1, "Removes harmful effects granted on yourself and the ally target you selected, and recovers the HP of yourself and the ally by 30% of your MAX HP through meditation." , 3, false));
