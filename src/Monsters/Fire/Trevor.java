...
public class Trevor extends Monster
{
    ...
    private void setAbilities()
    {
        ...
        abilities.add(new Passive("Brawler's Will", "As your HP decreases, the damage inflicted to the enemy will increase and the damage you receive " +
                "will decrease. " +
                "The damage you receive will decrease by 20% additionally if you are under harmful effects."));
    ...
    public boolean nextTurn(Monster target, int abilityNum)
    {
        ...
        {
            addAppliedBuff(Buff.CRIT_RATE_UP, 2, this);
        }
    ...
    public double dmgIncProtocol(double num)
    {
        ...
        //@Passive
        double ratio = (1.0 * getCurrentHp() / getMaxHp());
    ...
    public double dmgReductionProtocol(double num)
    {
        ...
        return (!getAppliedDebuffs().isEmpty()) ? num * 0.8 : num;
    }
}
